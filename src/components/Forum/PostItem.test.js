...
describe('PostItem Accessibility', () => {
    ...
    it('renders moderator actions with accessible labels', () => {
        ...
        // Multiple Copy User ID buttons exist (desktop and mobile), verify at least one exists
        const copyIdBtns = screen.getAllByLabelText('Copy User ID');
        expect(copyIdBtns.length).toBeGreaterThan(0);
    });
